...
const INTRO_COPY: Record<Language, InstructionCopy> = {
  ...
  es: {
    intro: 'Sigue esta guía para construir moléculas más rápido, editar estructuras con precisión e inspeccionar la geometría.',
    ...
    groupDescriptions: {
      build: 'Crea la estructura inicial y conecta átomos.',
      edit: 'Selecciona un enlace para usar acciones explícitas de Mejorar/Eliminar y ajustar rápido.',
      navigate: 'Controla cámara y zoom para inspeccionar mejor.',
    },
    quickTips: [
      'Ruta principal: toca un enlace y usa los botones de Mejorar/Eliminar.',
      'Usa el modo Eliminar como atajo de limpieza y vuelve a Construir después.',
      'Para rotar con precisión, selecciona un enlace simple y luego mantén Shift al arrastrar.',
      'En móvil, usa dos dedos para zoom y evita tapar los átomos al arrastrar.',
    ],
  },
  zh: {
  ...
  fr: {
    intro: 'Suivez ce guide pour construire des molécules plus vite, ajuster les structures avec précision et vérifier la géométrie.',
    controlsLabel: 'commandes disponibles',
    stepsLabel: 'étapes',
    groups: {
      build: 'Démarrage',
      edit: 'Édition et ajustement',
      navigate: 'Navigation de vue',
    },
    groupDescriptions: {
      build: 'Placez les atomes et créez les liaisons de base.',
      edit: 'Sélectionnez une liaison puis utilisez Améliorer/Supprimer pour éditer clairement.',
      navigate: 'Contrôlez caméra et zoom pour mieux observer.',
    },
    quickTips: [
      'Flux principal : touchez une liaison puis utilisez les boutons Améliorer/Supprimer.',
      'Utilisez le mode Supprimer comme raccourci de nettoyage, puis revenez en mode Construire.',
      'Pour une rotation précise, ciblez une liaison simple avant Shift + glisser.',
      'Sur mobile, zoomez avec deux doigts et évitez de masquer les atomes.',
    ],
  },
  ja: {
