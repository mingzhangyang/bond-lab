...
const PAGE_COPY: Record<Language, PrivacyCopy> = {
  ...
  es: {
    intro: 'Esta página explica qué guarda BondLab, qué permanece en tu dispositivo y cuándo intervienen servicios externos.',
    assurance: 'Privacidad primero: BondLab está diseñado para funcionar localmente sin seguimiento de cuentas.',
    highlights: ['No requiere inicio de sesión para funciones principales', 'La mayoría de acciones se procesan en tu navegador'],
    lastUpdatedLabel: 'Última actualización',
    sectionSummaries: {
      dataCollection: 'Qué información se procesa mientras usas BondLab.',
      localStorageUsage: 'Qué ajustes se guardan en el navegador para mantener la continuidad.',
      externalServices: 'Cuándo se puede enviar información fuera del dispositivo y cómo se informa.',
      updatesAndContact: 'Cómo se notifican cambios de política y dónde consultar dudas.',
    },
  },
  zh: {
  ...
  fr: {
    intro: 'Cette page explique ce que BondLab stocke, ce qui reste sur votre appareil et quand des services externes sont utilisés.',
    assurance: 'Confidentialité par défaut : BondLab fonctionne localement sans suivi de compte.',
    ...
    sectionSummaries: {
      dataCollection: 'Quelles informations sont traitées pendant votre utilisation de BondLab.',
      localStorageUsage: 'Quels réglages sont gardés localement dans le navigateur.',
      externalServices: 'Quand des données peuvent sortir de votre appareil et comment cela est annoncé.',
      updatesAndContact: 'Comment les mises à jour sont communiquées et où poser vos questions.',
    },
  },
  ja: {
