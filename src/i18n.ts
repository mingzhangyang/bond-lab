...
const ES_MESSAGES: Messages = {
  ...
  ui: {
    ...
    buildMode: 'Construir',
    deleteMode: 'Eliminar',
    removeHint: 'Modo Eliminar: toca atomo/enlace para quitar.',
...
const FR_MESSAGES: Messages = {
  ...
  ui: {
    ...
    pressEscToExit: 'Appuyez sur Echap pour revenir au mode Construire.',
    bondRemoved: 'Liaison supprimee.',
    undo: 'Annuler',
    bondActions: 'Liaison',
    bondOrderLabel: 'Ordre',
    upgradeBond: 'Ameliorer',
    ...
    controlsList: [
      ...
      'Touchez une liaison pour la selectionner puis utilisez Ameliorer/Supprimer',
